...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const tfMap = { '12h': 'smooth_12h', '6h': 'smooth_6h', '4h': 'smooth_4h', '2h': 'smooth_2h', '1d': 'smooth_1d' };
    const field = tfMap[tf] || 'smooth_3h';
    const selectFields = multi
      ? 'time, currency, smooth_2h, smooth_3h, smooth_4h, smooth_6h, smooth_12h, smooth_1d, raw_2h, raw_3h, raw_6h, raw_12h'
      : `time, currency, ${field}`;
    const sb    = getClient();
