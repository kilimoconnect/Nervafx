...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const shown = pairs.filter(p => p.broke && p.state !== 'REVERSAL_CANDIDATE' && p.energy >= 90 && p.confirmAligned)
      .sort((a, b) => order[a.state] - order[b.state] || b.score - a.score);   // energy >= 90, aligned 15mHA/M15/M5
